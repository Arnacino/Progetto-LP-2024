             ...
             (cond ((and 
                ...
                (let ((smaller-child (if (<= (heap-array-key heap-id leftc) 
                  ...
                  (when (> (heap-array-key heap-id i) 
                    ...
                    (setf aux (aref (heap-actual-heap heap-id) i))
                    (setf (aref (heap-actual-heap heap-id) i) 
                          (aref (heap-actual-heap heap-id) smaller-child))
                    (setf (aref (heap-actual-heap heap-id) smaller-child) aux)
                ...
                (when (> (heap-array-key heap-id i) 
                    ...
                    (setf aux (aref (heap-actual-heap heap-id) i))
                    (setf (aref (heap-actual-heap heap-id) i) 
                          (aref (heap-actual-heap heap-id) leftc))
                    (setf (aref (heap-actual-heap heap-id) leftc) aux)
                ...
                (when (> (heap-array-key heap-id i) 
                    ...
                    (setf aux (aref (heap-actual-heap heap-id) i))
                    (setf (aref (heap-actual-heap heap-id) i) 
                          (aref (heap-actual-heap heap-id) rightc))
                    (setf (aref (heap-actual-heap heap-id) rightc) aux)
